...
- 2025/11/23 Version 1.24 RS-MIDI実験版
 
## Version 1.24について
- Version 1.24はRS-232C（シリアルポート）を経由してMIDIキーボードからの演奏を行うための実験版です。
...
- そのため、Version 1.24はテスト用バージョンですので仮のリリースとなり、テスト結果次第では削除となる可能性が大ですのでご了承下さい。
